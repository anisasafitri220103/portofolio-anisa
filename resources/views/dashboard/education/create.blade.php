...
@section('konten')
    ...
    <form action="{{ route('education.store') }}" method="POST">
        ...
        <div class="mb-3">
            <label for="info2" class="form-label">Nama Program Studi</label>
            <input
                type="text"
                class="form-control form-control-sm"
                name="info2"
                id="info2"
                aria-describedby="helpId"
                placeholder="Nama Program Studi" value="{{ Session::get('info2') }}">
        </div>
        <div class="mb-3">
            ...
            <input
                ...
                id="info3"
                aria-describedby="helpId"
                placeholder="Nilai IPK" value="{{ Session::get('info3') }}">
        </div>
        <div class="mb-3">
           <div class="row">
